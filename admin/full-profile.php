...
if ($mysqli->connect_error) {
    die("Could not connect database: " . $mysqli->connect_error);
}

// Select database (not necessary when creating connection with mysqli)

// Set charset if needed
$mysqli->set_charset("utf8");

// Now $mysqli is your connection object, you can use it for queries
?>
...
// Assuming $_GET['id'] is safe to use directly in the query, otherwise use prepared statements
$id = $_GET['id'];
